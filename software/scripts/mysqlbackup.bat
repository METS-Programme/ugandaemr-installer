...
set errorLogPath="C:\Program Files\UgandaERM\scripts\logs\dumperrors.txt"

:: MySQL EXE Path
set mysqldumpexe="C:\Program Files\MySQL\MySQL Server 5.6\bin\mysqldump.exe"

:: Error log path
set backupfldr=C:\Program Files\UgandaERM\scripts\backupfiles\

:: Path to data folder which may differ from install dir
set datafldr="C:\Program Files\MySQL\MySQL Server 5.6\data"

:: Path to zip executable
set zipper="C:\Program Files\UgandaERM\scripts\zip\7za.exe"
