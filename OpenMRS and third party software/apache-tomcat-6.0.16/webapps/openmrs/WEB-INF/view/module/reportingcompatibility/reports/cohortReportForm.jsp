...
<h2>
	<c:if test="${empty command.reportId}"><spring:message code="reportingcompatibility.Report.new" /></c:if>
	<c:if test="${!empty command.reportId}"><spring:message code="reportingcompatibility.Report.edit" />: ${command.name}</c:if>
</h2>
...
<div id="reportTabs">
	<ul>
		<li><a href="#reportTab1"><span style="color:white;"><spring:message code="reportingcompatibility.Report.details" /></span></a></li>
		<c:if test="${!empty command.reportId}">
			<li><a href="#reportTab2"><span style="color:white;"><spring:message code="reportingcompatibility.Report.parameters" /></span></a></li>
			<li><a href="#reportTab3"><span style="color:white;"><spring:message code="reportingcompatibility.Report.indicators" /></span></a></li>
	...
	<form method="post">
		...
		<div id="reportTab1">
			<span style="color:blue;">
				...
				<c:if test="${!empty command.reportId}"><spring:message code="reportingcompatibility.Report.cohortReport.help.existingDetails" /></c:if>
			</span><br/><br/>
			<table>
				<spring:bind path="command.reportId">
					<tr>
						<th><spring:message code="reportingcompatibility.Report.id" /></th>
						<td>
							<c:if test="${empty status.value}">
								(<spring:message code="reportingcompatibility.Report.new" />)
							</c:if>
							${status.value}
				...
				<spring:bind path="command.name">
					<tr>
						<th><spring:message code="reportingcompatibility.Report.name" /></th>
						<td>
				...
				<spring:bind path="command.description">
					<tr valign="top">
						<th><spring:message code="reportingcompatibility.Report.description" /></th>
						<td>
		...
		<c:if test="${!empty command.reportId}">
			<div id="reportTab2">
				...
				<span style="color:blue;"><spring:message code="reportingcompatibility.Report.cohortReport.help.parameters" /></span><br/><br/>
				<table id="parametersTable">
					<tr>
						<th><spring:message code="reportingcompatibility.Report.parameter.name" /></th>
						<th><spring:message code="reportingcompatibility.Report.parameter.label" /></th>
						<th><spring:message code="reportingcompatibility.Report.parameter.type" /></th>
					</tr>
				...
				<a onClick="addAnotherParameter()"><spring:message code="reportingcompatibility.Report.parameter.add" /></a>
				<br/><br/>
				<input type="submit" value="<spring:message code="general.save"/>"/>
			</div>
			...
			<div id="reportTab3">
				<div id="cohortResult" style="display: none; position: absolute; z-index: 5; border: 2px black solid; background-color: #e0f0d0">
					...
					<b><u><spring:message code="reportingcompatibility.Report.cohortReport.preview" /></u></b>
					<br/>
					<openmrs:portlet url="cohort" parameters="linkUrl="/>
				</div>
				<span style="color:blue;"><spring:message code="reportingcompatibility.Report.cohortReport.help.indicators" /></span><br/><br/>
				<table><tr valign="top">
					<td>
						...
						<table id="rowsTable">
							<tr>
								<th nowrap>
									...
									(<spring:message code="reportingcompatibility.Report.cohortReport.indicatorName.example" />)
								</th>
								<th nowrap>
									<spring:message code="reportingcompatibility.Report.cohortReport.indicatorDescription" />
									(<spring:message code="reportingcompatibility.Report.cohortReport.indicatorDescription.example" />)
								</th>
								<th nowrap>
									<spring:message code="reportingcompatibility.Report.cohortReport.indicatorSpecification" />
									(<spring:message code="reportingcompatibility.Report.cohortReport.indicatorSpecification.example" />)
								</th>
								<th colspan="2">&nbsp;</th>
							</tr>
						...
						<a onClick="addAnotherRow()"><spring:message code="reportingcompatibility.Report.cohortReport.indicator.add" /></a>
					</td>
					<td width="*">
			
						<div id="shortcuts" style="border: 1px black solid; padding: 5px; background-color: #f0f0f0">
							<span style="font-weight:bold;"><spring:message code="reportingcompatibility.Report.cohortReport.operators" />:<br/></span><br/>
							<span class="button" onClick="handleShortcut('(')">&nbsp;(&nbsp;</span>
							<span class="button" onClick="handleShortcut(')')">&nbsp;)&nbsp;</span>
							<span class="button" onClick="handleShortcut('AND')"><spring:message code="reportingcompatibility.Report.cohortReport.operator.and" /></span>
							<span class="button" onClick="handleShortcut('OR')"><spring:message code="reportingcompatibility.Report.cohortReport.operator.or" /></span>
							<span class="button" onClick="handleShortcut('NOT')"><spring:message code="reportingcompatibility.Report.cohortReport.operator.not" /></span>
							<br/>
								
							<c:if test="${fn:length(macros) > 0}">
								<br/>
								<b><spring:message code="reportingcompatibility.Report.macros" />:</b>
							...
							<c:if test="${fn:length(patientSearches) > 0}">
								<br/>
								<b><spring:message code="reportingcompatibility.Report.cohortReport.savedPatientSearches" />:</b>
